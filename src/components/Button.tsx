...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      ghost:
        'rounded-md px-2 hover:bg-zinc-50 dark:hover:bg-white/5 dark:hover:bg-zinc-800 dark:hover:text-zinc-400 shadow-none text-zinc-500',
      outline:
...
export function Button({ variant, className, ...props }: ButtonProps) {
  return <button {...props} className={button({ variant, className })}></button>
}
