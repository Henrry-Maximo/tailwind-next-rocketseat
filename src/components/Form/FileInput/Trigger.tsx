...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className={twMerge(
        'group flex flex-1 cursor-pointer flex-col items-center gap-3 px-6 py-4 text-center shadow-sm',
        'rounded-lg border border-zinc-300 text-zinc-500',
    ...
    >
      <div
        className={twMerge(
          'rounded-full border-6 bg-zinc-100 p-2',
          'border-zinc-50 group-hover:border-violet-50 group-hover:bg-violet-100',
